...
var InfiniteScroll = /** @class */ (function (_super) {
    ...
    function InfiniteScroll(props) {
        ...
        _this.onScrollListener = function (event) {
            ...
            if (_this.actionTriggered)
                return;
            var atBottom = _this.props.horizontal
                ? _this.isElementAtRight(target, _this.props.scrollThreshold)
                : _this.props.inverse
            ...
            _this.lastScrollTop = target.scrollLeft;
        };
        _this.state = {
            showLoader: false,
            pullToRefreshThresholdBreached: false,
    ...
    InfiniteScroll.prototype.isElementAtRight = function (target, scrollThreshold) {
        if (scrollThreshold === void 0) { scrollThreshold = 0.8; }
        var clientWidth = target === document.body || target === document.documentElement
            ? window.screen.availWidth
            : target.clientWidth;
        var threshold = parseThreshold(scrollThreshold);
        if (threshold.unit === ThresholdUnits.Pixel) {
            return (target.scrollLeft + clientWidth >= target.scrollWidth - threshold.value);
        }
        return (target.scrollLeft + clientWidth >=
